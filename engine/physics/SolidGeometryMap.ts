...
export class SolidGeometryMap extends SolidMap {
   ...
   * @returns 
   */
  public override getOverlappingWalls(cube: Cube) {
   ...
   * @returns 
   */
  public override getOverlappingPlanes(position: Vector3, radius: number) {
